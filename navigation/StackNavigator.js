...
import OnionScreen from '../Screen/MainCrops/OnionScreen';
import GarlicScreen from '../Screen/MainCrops/GarlicScreen';
import PotatoScreen from "../Screen/MainCrops/PotatoScreen";
import MethiScreen from "../Screen/MainCrops/MethiScreen";
...
import WheatCropCycle from "../cropcalender/WheatCropCycle";
  ...
  const CropCalendarScreenStack = ({navigation}) => {
    return (
      <Stack.Navigator
        ...
        <Stack.Screen
          name="WheatCropCycle"
          component={WheatCropCycle}
          options={{
            title: 'Wheat Calendar', //Set Header Title
          }}
        />
      </Stack.Navigator>
    );
...
export { ProfileScreenStack, homeScreenStack, weatherScreenStack, MarketScreenStack, PricePredictionScreenStack,settingScreenStack ,CropCalendarScreenStack};